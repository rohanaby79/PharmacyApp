class PrescriptionsController < ApplicationController
  ...
  # STORY 19 — GET /prescriptions/history
  def history
  ...
  def print
    ...
    unless instruction
      return render json: {
        error: "No instructions found for prescription #{prescription_id}. Add instructions first."
      }, status: :not_found
    end
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .page { max-width: 750px; margin: 0 auto; background: #fff; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.10); overflow: hidden; }
          .header { background: #2c5f8a; padding: 28px 36px; display: flex; justify-content: space-between; align-items: center; }
          .header h1 { font-size: 20px; color: #fff; }
          .header p { font-size: 12px; color: rgba(255,255,255,0.75); margin-top: 4px; }
          .rx-badge { background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.3); border-radius: 8px; padding: 8px 16px; text-align: center; }
          ...
          .card-hdr { background: #2c5f8a; padding: 8px 14px; font-size: 11px; font-weight: bold; color: #fff; text-transform: uppercase; }
          ...
          .med { font-size: 18px; font-weight: bold; color: #2c5f8a; margin-bottom: 10px; padding-bottom: 10px; border-bottom: 1px solid #dde8f7; }
          .pills { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 10px; }
          .pill { background: #e8f0fe; border: 1px solid #c5d8fc; border-radius: 20px; padding: 3px 10px; font-size: 11px; color: #2c5f8a; }
          .pill span { color: #6b7fa3; margin-right: 3px; }
          .notes { background: #fffbeb; border: 1px solid #fde68a; border-radius: 6px; padding: 8px 12px; font-size: 12px; color: #78350f; }
          .sig-row { margin-top: 22px; padding-top: 18px; border-top: 1px dashed #dde8f7; display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
          .sig-label { font-size: 10px; font-weight: bold; color: #6b7fa3; text-transform: uppercase; margin-bottom: 22px; }
          .sig-line { border-bottom: 1.5px solid #2c5f8a; margin-bottom: 5px; }
          .sig-cap { font-size: 10px; color: #6b7fa3; }
          .footer { background: #f0f4fb; border-top: 1px solid #dde8f7; padding: 12px 36px; display: flex; justify-content: space-between; }
          .footer p { font-size: 10px; color: #8899b8; }
          .stamp { background: #d5f5e3; border: 1px solid #82e0aa; border-radius: 5px; padding: 3px 10px; font-size: 10px; font-weight: bold; color: #1e8449; }
          .print-btn { text-align: center; padding: 16px; }
          .print-btn button { background: #2c5f8a; color: white; border: none; padding: 10px 28px; border-radius: 8px; font-size: 14px; font-weight: bold; cursor: pointer; }
          ...
          <div class="body">
            ...
            <div class="sig-row">
              ...
              <div>
                ...
                <div class="sig-line"></div>
                <div class="sig-cap">MM / DD / YYYY</div>
              </div>
            </div>
          </div>
          <div class="footer">
